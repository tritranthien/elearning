  ...
  return (
    <div>
      ...
      <section className="py-24 text-center">
        <div className="container mx-auto px-4">
          <div className="max-w-[800px] mx-auto">
            ...
            <h1 className="text-3xl md:text-6xl font-black leading-tight tracking-tight text-gray-900 mb-6">
              Làm chủ 1000+ từ vựng <br className="hidden md:block" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={user ? "/topics" : "/register"} className="px-8 py-4 rounded-xl bg-primary text-white text-lg font-bold shadow-sm hover:bg-primary-dark hover:-translate-y-px hover:shadow-glow transition-all w-full sm:w-auto">
                {user ? "Tiếp tục học" : "Bắt đầu ngay"}
              </Link>
              <Link to="/topics" className="px-8 py-4 rounded-xl border border-gray-200 bg-white text-gray-700 text-lg font-bold hover:border-primary hover:text-primary transition-colors w-full sm:w-auto">
                Khám phá kho từ
              </Link>
            </div>
            ...
            <div className="mt-16 opacity-80">
              ...
              <div className="flex flex-wrap justify-center gap-6 md:gap-12 grayscale opacity-60 px-4">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black mb-4 text-gray-900">Tại sao LinguaFast hiệu quả?</h2>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="rounded-3xl bg-gradient-to-br from-primary to-primary-dark p-8 md:p-16 text-center text-white shadow-xl">
            <h2 className="text-3xl md:text-4xl font-black mb-6">Mở rộng vốn từ ngay hôm nay</h2>
            ...
            <Link to={user ? "/topics" : "/register"} className="block w-full sm:inline-block sm:w-auto px-10 py-4 rounded-xl bg-white text-primary text-lg font-black shadow-2xl hover:bg-gray-50 hover:-translate-y-1 transition-all">
